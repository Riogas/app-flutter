...
class _PedidosTabV2State extends State<PedidosTabV2> {
  ...
  int _pedidoIdDe(Map<String, dynamic> pedido) => PedidoActionsV2.idDe(pedido);

  /// Delegado a PedidoActionsV2 (lógica compartida con el Mapa V2)
  Future<void> _abrirDetalle(Map<String, dynamic> pedido,
      {bool autoFinalize = false}) {
    return PedidoActionsV2.abrirDetalle(context, pedido,
        autoFinalize: autoFinalize);
  }

  /// Delegado a PedidoActionsV2 (lógica compartida con el Mapa V2)
  Future<void> _iniciarViaje(Map<String, dynamic> pedido) {
    return PedidoActionsV2.iniciarViaje(context, pedido);
  }
